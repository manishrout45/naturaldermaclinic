...
export default function ServiceSection() {
  ...
  return (
    <section id="service" className="bg-gradient-to-b from-green-900 via-green-600 to-green-950 py-20">
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl w-full">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white shadow-sm hover:shadow-md transition text-center"
              >
                {/* Image */}
